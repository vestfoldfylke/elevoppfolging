...
PUBLIC_STUDENT_OVERVIEW_TOP="100" # Optional. The number of students to show in the student overview page. This is a public variable that can be accessed in the frontend using import.meta.env.PUBLIC_STUDENT_OVERVIEW_TOP. If not set, it defaults to 100.
```
