...
{#if messageType === null}
  <div class="new-message-actions">
    ...
    <button class="ds-button" data-variant="secondary" data-size="sm" onclick={() => messageType = "update"}><span class="material-symbols-outlined">info</span>Ny oppdatering</button>
  </div>
