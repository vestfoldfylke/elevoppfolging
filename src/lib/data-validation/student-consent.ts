...
export const validateStudentDataSharingConsentData = (consentData: StudentDataSharingConsentInput): ValidationResult => {
  ...
  if (typeof consentData.message !== "string" || consentData.message.length < studentDataSharingConsentMessageValidation.minLength || consentData.message.length > studentDataSharingConsentMessageValidation.maxLength) {
