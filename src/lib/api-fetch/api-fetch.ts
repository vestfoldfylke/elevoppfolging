...
type ApiFetchOptions<Route extends keyof ApiRouteMap, Method extends keyof ApiRouteMap[Route]> = 
...
export const apiFetch = async <
  ...
  Route extends keyof ApiRouteMap, Method extends keyof ApiRouteMap[Route]
>(route: Route,
  ...
  options: ApiRouteMap[Route][Method] extends { req: unknown }
    ? ApiFetchOptions<Route, Method>
    : ApiFetchOptions<Route, Method> | (Omit<ApiFetchOptions<Route, Method>, "body"> & { body?: never })
