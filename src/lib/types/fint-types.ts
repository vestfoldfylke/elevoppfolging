...
export type Arstrinn = {
	...
	klasse?: Maybe<Array<Maybe<Klasse>>>
	/** Gruppe */
	navn: Scalars["String"]["output"]
...
export type Elevforhold = {
	...
	klassemedlemskap?: Maybe<Array<Maybe<Klassemedlemskap>>>
...
export type Klassemedlemskap = {
	__typename?: "Klassemedlemskap"
	/**
	 * Gruppemedlemskap
	 * Relations
	 */
...
export type Query = {
	...
	karakterverdi?: Maybe<Karakterverdi>
	klasse?: Maybe<Klasse>
	klassemedlemskap?: Maybe<Klassemedlemskap>
...
export type QueryKlasseArgs = {
	systemId?: InputMaybe<Scalars["String"]["input"]>
}

export type QueryKlassemedlemskapArgs = {
	systemId?: InputMaybe<Scalars["String"]["input"]>
}
