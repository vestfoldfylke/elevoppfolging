import type { ClassAutoAccessEntry, ContactTeacherGroupAutoAccessEntry, DbAccess, DbAppStudent, DbAppUser, ProgramAreaManualAccessEntry, SchoolManualAccessEntry, StudentManualAccessEntry, TeachingGroupAutoAccessEntry } from "./db/db";
